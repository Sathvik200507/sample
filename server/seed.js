...
const sampleUsers = [
  {
    ...
    recentDonations: [
      { item: "Milk Packets", description: "2L full cream", time: "2 days ago", ptsEarned: 120 },
      { item: "Vegetables", description: "Carrots and tomatoes", time: "5 days ago", ptsEarned: 120 },
      { item: "Packaged Meals", description: "50 boxes", time: "3 hours ago", ptsEarned: 120 },
      { item: "Fruits", description: "Oranges and Apples", time: "3 days ago", ptsEarned: 120 }
    ],
    donationPercentages: [
  ...
  },
  {
    ...
    impactLevel:"Community Hero",
    recentDonations: [
      { item: "Bread Loaves", description: "10 packs", time: "1 day ago", ptsEarned: 120 }
    ],
    donationPercentages: [
  ...
  },
  {
    ...
    impactLevel:"Community Hero",
    recentDonations: [
      { item: "Dairy Boxes", description: "Cheese & Milk", time: "4 days ago", ptsEarned: 120 }
    ],
    donationPercentages: [
